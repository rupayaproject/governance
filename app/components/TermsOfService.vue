    ...
    <div class="container">
        <b-card class="tomo-card">
            ...
            <div class="container">
                ...
                <h5>1. Risks related to the use of Governance </h5>
                <p>
                    Governance will not be responsible for any losses, damages or claims arising from
                ...
                <p>
                    (2) Software problems of Governance and/or any cryptocurrency-related software
                ...
                <h5>2. Trading and Investment risks</h5>
                <p>
                ...
                <p>
                    The users of Governance are solely responsible to determinate what, if any, taxes apply
                    to their crypto-currency transactions. The owners of, or contributors to, Governance are NOT
                ...
                <h5>5. Arbitration</h5>
                <p>
                    The user of Governance agrees to arbitrate any dispute arising from or in connection with
